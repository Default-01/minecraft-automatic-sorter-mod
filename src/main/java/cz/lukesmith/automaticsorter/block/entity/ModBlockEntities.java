...
public class ModBlockEntities {
    ...
    public static void registerModBlocksEntities() {
        FILTER_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(AutomaticSorter.MOD_ID, "filter_be"), FabricBlockEntityTypeBuilder.create(FilterBlockEntity::new, ModBlocks.FILTER_BLOCK).build(null));
